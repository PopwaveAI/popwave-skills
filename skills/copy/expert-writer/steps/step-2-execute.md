...
|:-----|:-----|:-------|:---------|:---------|:---------|
| Step0 | 导演意图提取 | 主会话 | 从幕纲结构分析表取本章行→组装导演意图（≤150字） | **CHECK 1**：用户确认 | step-2-0-director-intent.md |
| Step1 | 状态快照投影 | 主会话 | 从活记忆+幕纲物理坐标投影当前状态（≤400字） | 无 | step-2-1-state-snapshot.md |
...
2. 从活记忆最新events + 幕纲物理坐标段实时投影当前状态（≤400字）
