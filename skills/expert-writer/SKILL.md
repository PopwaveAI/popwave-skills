...
| 步骤 | 动作 | 硬门禁 | 验证证据 |
|:--|:--|:--|:--|
| Step0 本章规划 | 读种子六要素+活记忆→做任务list规划→产出chapter_plan | plan状态必须"已确认"才能进Step1 | 章节规划/chXXX-plan.md 顶部状态字段 |
| Step1 信息获取 | 强制读资料总索引.md→处理info_gaps→4类补充检查 | 资料总索引未读=退回补读 | 资料总索引.md被read记录 |
...
**种子设计**(pop-writer-v3-seed) → **涌现写作环**(expert-writer主会话6步循环，调度create/revise) ↔ **弧线校准**(pop-writer-v3-arc)
