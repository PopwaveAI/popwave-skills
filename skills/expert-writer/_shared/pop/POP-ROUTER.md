...
|:---------|:-----------|:---------|:-----|
| 新书启动 / 开书 / 设世界观 | `pop-writer-creative` (forward) | 一个故事想象 | story-engine.yaml + L1 设定 + 宪法 + 数值体系 + 起点快照 + 终点快照 |
...
| 续写 / 交接已有项目 | `pop-writer-creative` (reverse) | 已有正文 | event logs + 逆向 L1 + 宪法 |
...
| 用户输入包含 | 路由 skill |
|:---|:---|
| 开书 / 启动 / 新书 / 设定 | `pop-writer-creative` (forward) |
...
| 续写 / 交接 / 已有正文 | `pop-writer-creative` (reverse) |
