...
| 5 plot | pop-writer-plot | v7.6.0 | `剧情设计/卷/卷{N}-卷纲.md` + `剧情线/*.md` + `剧情设计/幕/vol-XX/act-YY.md` | world+character 产出齐全 + trop-library 已查 | 里程碑确认 | 套路库/ + 剧情库/ + 元爽点-变体映射表 |
| 6 chapter | pop-writer-chapter | v2.2.0 | `章节设计包/chXXX-设计包.md` + entity-snapshot更新 + act-YY枪链更新 | plot 产出齐全 | — | 套路库/{具体套路名}.md |
| 7 prose | pop-writer-prose | v3.0.1 | `正文/chXXX.md` + 总控更新 | chapter 设计包就绪 + 文风DNA就位 | — | 文风DNA/{书名}.md |
...
| 文件 | 产出阶段 | 消费阶段 | S/D |
|:-----|:---------|:---------|:---:|
| `剧情设计/卷/卷{N}-卷纲.md` | plot | chapter | S→D |
...
| `状态/entity-snapshot.yaml` | chapter（每章设计后更新） | chapter(下一章), prose, qa | D |
