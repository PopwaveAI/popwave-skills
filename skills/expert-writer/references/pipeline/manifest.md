...
|:-----|:-----------|:-----|:---------|:---------|:-----|
| 1 creative | pop-writer-creative | v4.3.0 | `全书立项PRD.md`（10块结构） | 无（开书入口） | 样品确认签字 |
| 2 reservoir | pop-writer-reservoir | v2.2.0 | `素材储备池/{素材}.md`（剧情储备卡，含安全门禁） | creative 产出齐全 | 安全门禁通过 |
| 3 world | pop-writer-world | v1.5.0 | `小说世界设定/L1-01~06.md` + `数值体系/*.md`×4 + `起点快照.md` + `终点快照.md` + `动态升级表.md` | reservoir 有剧情储备卡可用 | 宪法锁定 |
| 4 character | pop-writer-character | v2.0.1 | `状态/角色/{主角,配角}-角色卡.md` | world 产出齐全 | 角色卡确认 |
| 5 plot | pop-writer-plot | v7.0.0 | `剧情设计/卷/卷{N}-战略定位.md` + `剧情线/*.md` + `剧情设计/幕/vol-XX/{分幕规划,act-YY,chekhov-tracker}.md` | world+character 产出齐全 + trop-library 已查 | 里程碑确认 |
| 6 chapter | pop-writer-chapter | v2.0.0 | `章节设计包/chXXX-设计包.md` | plot 产出齐全 | — |
| 7 prose | pop-writer-prose | v3.0.1 | `正文/chXXX.md` + entity-snapshot更新 + chekhov更新 + 总控更新 | chapter 设计包就绪 + 文风DNA就位 | — |
| 8 qa | pop-writer-qa | v1.0.1 | （不留盘）L1硬门禁→L2三层介入→L3原文对照 | prose 正文产出 | — |
