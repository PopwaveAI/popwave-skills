...
> 消费: 种子文档.md + Step 1信息获取 + 种子文件夹 + 活记忆
> 产出: 正文初稿 + 创作决策记录
...
**种子文档全文传入（v3.5）：** 传入`种子文档.md`全文（含任务表[主线/压力/线索任务]+要素切片+本章聚焦），替代原来的task-list（章节规划/chXXX-plan.md）。create在涌现写作中以"本章聚焦"段为框架自主涌现，仅可回写"本章聚焦"段，不得修改任务表与要素切片段。
