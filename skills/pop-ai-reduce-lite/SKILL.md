...
> **D8 · 抽象对偶比喻**（AI 腔"看起有深度、实际零信息"的典型结构）：
> 检测：抽象名词A（命/命运/世界/时代/历史/文明/人生/人性/压迫/真相/意义/欲望）接 联结词（是/像/如同/宛如/化作/成了）接 抽象陈词B（账本/记账/契约/迷宫/深渊/棋局/棋盘/天平/洪流/注脚/泡沫/答卷）。命中 → `[!]`。
> 判据三条：
> 1. **两端须具体可感**：至少一端是能看见/摸到的物（锈铁/锅底/老街/断梯）。两端都抽象 → 删或换具体物。
> 2. **必须加信息**：删掉这句，读者会少知道哪件具体的事？只"换皮不分改信息"（把压迫叫账、把世界叫迷宫）→ 改直陈。
> 3. **贴合影象豁免**：喻体若是本作叙事真实贴合的核心意象（主角真在跟外神对弈→"棋手/一步棋"），非为升华而空 → 保留，不判。
