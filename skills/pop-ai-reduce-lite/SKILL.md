...
description: 用户说"降AI/去AI味/降朱雀/润色"时触发。实现整包替换自 @user_741dc82b/libai（李白.Skill:润色专家 v2.0）：检测并消除中文文本中的AI生成痕迹，规则检测+分层改写+质控流水线一次到位（A/B/C三模式交付），不再路由深度 skill。非 snow 创作管线默认流程，仅手动触发。
version: "2.0.0"
author: "智慧半岛"
triggers:
  - 去AI味
