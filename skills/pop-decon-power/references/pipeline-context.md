...
| 输入 | 来源 | 输出 | 下游 |
|:-----|:-----|:-----|:-----|
| 章节白描（必） | pop-decon-design-pack | 力量体系骨架 + 主角升级路线 + 战斗体系 | pop-decon-character、pop-decon-world、pop-decon-prd |

## 铁律

- 前置：必须先有章节白描
- 境界链无chXX证据且未标注「数据极少」=编造
- 战斗需按五轴标注（作用距离/作用方式/增益方向/参与形态/节奏形态）
