...
# pop-decon-setting · 设定世界观+角色+叙事资产 v3.0.0

> **定位**：Phase 3 of deconstruction. 以"服务续写/同人"为原目的，产出设定层+角色层+势力层+叙事资产层四类产出物。
...
| 3 | 历史与驱动力 | Phase 2 L3剧情线 | 大事件时间线 | `L1-03-历史与驱动力.md` | — |
...
| 10 | 金手指设计 | Phase 1 设计包 + Phase 2 L2单元卡 | 面板/系统数据+金手指触发事件 | `L1-07-金手指设计.md` | 与L1-02交叉验证 |
| 11 | 主要角色人物卡 | L1-04 + Phase 2 L2/L3 + 原文对白 | 角色行为轨迹+对白 | `主要角色人物卡.md` | 含敌人卡 |
...
| 步骤 | 操作 | 读什么 | 数据来源 | 产出 | 门禁 |
|:-----|:-----|:-------|:---------|:-----|:-----|
| 5 | 势力格局 | Phase 2 L2单元卡数据 | 势力动机/权力关系 | `L1-05-势力格局.md` | 关系图谱在人物卡，冲突表在伏笔追踪 |
...
```
前N章: L1-01~07 + 主要角色人物卡 + 世界观弹性边界 + 伏笔追踪表 + 角色对白风格库 + 经典场景拆解
       + combat_capability(可选) + 起点快照(可选)
全书: + 终点快照(可选) + L1 全书版
```
