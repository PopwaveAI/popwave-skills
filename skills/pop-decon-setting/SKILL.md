# pop-decon-setting · 设定世界观 v1.0.0

> **定位**：Phase 4 of deconstruction. 从全部分析数据中归纳 L1 六件套 + 世界宪法 + 数值体系。
...
```
正文 → 事实提取 → 卷幕聚类 → 设定世界观
       Phase 1/2    Phase 3    Phase 4 (终Phase)
                                ↑
                        这是你在这里 ← Phase 4
```

**upstream**: pop-decon-volume | **downstream**: — | **expert**: pop-decon
