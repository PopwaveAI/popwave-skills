...
> Phase 2 of 拆书管线。从白描卡产出叙事白描（叙事层）→L2剧情单元卡+卷纲（含溯源燃料台+叙事技法分析），不直接产出文件。
...
| 我要 | 读什么文件 | 什么时候读 |
|:-----|:----------|:----------|
| 查叙事白描流程 | steps/step-0-叙事白描.md | 将白描卡串联为叙事白描时 |
...
v7.0.0 | 2026-07-14 | 新增Step 0叙事白描（全书剧情白描层）→ [CHANGELOG.md](CHANGELOG.md)

v6.0.0 | 2026-07-14 | 融合六维拆文法维度4+5→叙事技法分析
v5.0.0 | 2026-07-01 | 删除套路聚合步骤+按v6.0.0规范重构
