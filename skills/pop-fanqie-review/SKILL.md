...
输出审核报告+verdict+更新current-state（白描驱动版，归档旧版→写新版）+更新小说快照（replace+三档压缩）+追加review-沉淀日志。
...
v4.7.0 | 2026-08-11 | current-state白描化：回溯交给剧情白描+信息差+钩子回收+禁止漂移，小说快照三档压缩防膨胀 → CHANGELOG.md
