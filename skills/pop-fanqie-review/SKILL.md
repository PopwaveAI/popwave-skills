...
| `steps/step1.md` | Step 1-3 | 正向符合性+番茄底线+正文质量(AI味检测15项patterns+高疲劳词3级+结构性4项+自检+DNA+好看度4问)+反向充足性 |
...
v4.5.0 | 2026-07-26 | AI味检测升级：7项→15项patterns+高疲劳词3级+结构性4项+自检 → [CHANGELOG.md](CHANGELOG.md)
