...
PHASES = [
    {
        ...
        "guide": "执行 skill-project-bootstrap → 或手动创建 project.yaml + 目录骨架",
        "skill": "skill-project-bootstrap",
    ...
    },
    {
        ...
        "skill": "skill-project-bootstrap Phase 0",
    ...
    },
    {
        ...
        "skill": "skill-project-bootstrap Phase 1",
        "check_files": [
    ...
    },
    {
        ...
        "guide": "运行 skill-plot-architecture → 产出 02-章纲/volume-1-outline.yaml",
        "skill": "skill-plot-architecture",
        "check_files": [],
...
WRITING_PHASES = [
    {
        ...
        "guide": "运行 skill-chapter-outline → 产出 02-章纲/chXXX.yaml",
        "skill": "skill-chapter-outline",
        "check_files": [],
    ...
    },
    {
        ...
        "skill": "skill-emergent-writer director→write→qc",
        "check_files": [],
    ...
    },
    {
        ...
        "guide": "python skills/skill-emergent-writer/scripts/update_global_summary.py --project-dir \"{dir}\" --chapter N --chapter-file \"03-正文/chN.md\"",
    ...
    },
    {
        ...
        "guide": "运行 skill-reader-qa SOP-R → 产出 06-复盘/*.md",
        "skill": "skill-reader-qa",
        "check_files": [],
        "outputs": ["06-复盘/*.md"],
    },
]
...
def build_guide(phase_id: str, project_path: str, phase_count: int, file_status: dict) -> str:
    ...
    if phase_id.startswith("T"):
        ...
        # 写作阶段
        guides = {
            "W0": f"执行 <code style='background:#2a2d3a;padding:0.1rem 0.4rem;border-radius:0.3rem;font-size:0.8rem;'>skill-chapter-outline</code> → 产出当前幕的章纲",
            "W1": f"执行 <code style='background:#2a2d3a;padding:0.1rem 0.4rem;border-radius:0.3rem;font-size:0.8rem;'>skill-emergent-writer</code> → 导演层 → 碎片写作 → QC",
            ...
            "W3": f"执行 <code style='background:#2a2d3a;padding:0.1rem 0.4rem;border-radius:0.3rem;font-size:0.8rem;'>skill-reader-qa SOP-R</code> → 审稿 → 存档 → 复盘",
        }
