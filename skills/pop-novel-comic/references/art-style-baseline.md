...
- **模型**：`doubao-seedream-5-0-pro-260628` / **尺寸**：`1728x2304` / **参数**：纯文生图
...
|:-----|:-----|:---------|:-------|:-------|:-------|:-----|
| 秦铭 | v4 | 仙侠玄幻国漫立绘 | 统一立绘串 + 夜无疆配色 | `char-秦铭-v4-front.png` | R3-定妆 | 1728x2304 |
| 陆泽 | v4 | 仙侠玄幻国漫立绘 | 统一立绘串 + 夜无疆配色 | `char-陆泽-v4-front.png` | R3-定妆 | 1728x2304 |
