...
> 网文封面与场景视觉资产生成器。两种起点，同一个终点。v1.2.1
...
- **优先读取 `素材/视觉资产/` 下的资产文件**（pop-novel-asset 产出）：场景资产表→帧解构、角色档案→角色规格、视觉符号库→环境材质、IP视觉DNA→IP背景
...
| ❌3 | **参考点放权一致性** — 用户选了什么参考点，提示词就在那个维度放弃控制权 | 提示词与参考图矛盾 |
