...
| 子skill | 职责 |
|:--------|:-----|
| `pop-novel-bootstrap` | 开书启动+续写适配：故事引擎→L1新六件套→稳定性→宪法→数值体系。正向(forward)新书，反向(reverse)续写 |
...
|:--------|:--------------------|:---------|
| bootstrap | story-engine 确认 | 产出展示给用户 → 说"对"才进 Phase 0.3 |
...
L2 ─ 一致性检查
    □ 产出与上游设定/宪法/幕纲一致？
      ...
      - plot 幕纲是否与 story-engine.yaml 的核心冲突类型对齐？
...
| 版本 | 日期 | 变更 |
|:----|:----|:-----|
| v1.5 | 2026-06-05 | master 全线同步：bootstrap 描述→故事引擎+新L1六件套；决策点→story-engine确认；think-开书设定 PRD→story-engine；Reflect L2检查→story-engine字段；POP-ROUTER/POP-CALL 旧skill名全部修复→pop-novel-*；spec-bridge/glue编排器旧引用删除 |
