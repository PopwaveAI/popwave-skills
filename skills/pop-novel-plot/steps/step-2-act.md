...
④ ★ 标注每条线在本章的 payoff_level（详见 `references/payoff-design-guide.md` §三）：
    - 空 = 铺垫/建设/埋伏笔
...
| `payoff_distribution` | 密度约束：小≥5/章 / 中≥1/章 / 大间隔≤5章 / 特大≥1/卷。positions 从 Canvas 反推。设计方法论 → `references/payoff-design-guide.md` |
