...
- 从番茄小说创作 skill 群的 plot-design 迁移至 pop-qidian-plot。
- SKILL.md 新增 frontmatter（name: pop-qidian-plot）。
...
- 新增 skill.json，声明 pipeline 上下游关系（upstream: pop-qidian-seed, downstream: pop-qidian-review）。
