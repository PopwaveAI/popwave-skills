...
> 起点调研引擎。四档：燃料+题材机制 / decon-lite 9表拆书 / 赛道定位调研 / decon-plot剧情拆解。v4.6.0：skill.json 面向用户介绍+可调用专家标签+版本同步。完整版本历史见 [CHANGELOG.md](CHANGELOG.md)。
...
v4.5.0 | 2026-08-12
- **燃料筛入目标对齐双文件**：燃料文档"可筛入 current-state"全部改为"可筛入状态快照"（fuel-doc模板/step-1/step-2），对齐剧情记录双文件收束（review 产出白描卡+状态快照，废除 current-state）
v4.4.0 | 2026-07-24
