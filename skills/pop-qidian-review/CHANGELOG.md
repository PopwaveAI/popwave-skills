...
### 联动检查项增强：与character/plot/write新维度对齐

**改动背景**：character v1.3.0/v1.4.0新增行为逻辑三源+人物真相+关系网络；write v3.6.0新增视角设计框架；plot v4.4.0新增剧情理论锚点。review需要联动检查这些新维度的落地。

**改动**：
- **1c 角色一致性增强**：从基础OOC检查升级为4项深度一致性检查——基础OOC + 行为逻辑三源一致性 + 人物真相一致性 + 关系网络一致性
- **2c 好看度4问→5问**：新增第5问"视角选择合理吗？"——检查视角是否服务章型+信息藏露是否产生目标效果+视角切换是否有标志+内外视角配比
- **3c 角色卡充足性增强**：从3项扩展为6项——新增行为逻辑三源充足性+人物真相充足性+关系网络图充足性
- 门禁更新：好看度4问→5问
- SKILL.md红线4更新：5问必须给具体证据（含第5问视角检查标准）
- SKILL.md速查表更新
- skill.json version 3.5.0→3.6.0
