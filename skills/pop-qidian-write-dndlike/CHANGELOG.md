...
### 新建：番茄 dndlike 复制更名
- 从番茄小说创作skill群的 prose-render-dndlike 复制更名为 pop-qidian-write-dndlike。
- 新增 frontmatter（name: pop-qidian-write-dndlike）。
...
- 流派技法（战斗模式×3等级段/面板叙事/数据化分析/怪物鉴定/场景卡/特殊条件战/多线叙事）保持不动。
