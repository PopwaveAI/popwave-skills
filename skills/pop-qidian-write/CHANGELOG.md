...
### 新增：视角设计框架 + 章意图7问
- 新增`references/视角设计框架.md`——视角≠人称+四种视角类型（全知/有限/摄影机/说书人）+内外视角配比+信息池概念+信息藏露三层次+三种效果策略（期待感/悬念感/代入感）+宏观/微观视角组织
- `step-1-consume.md`章意图从6问升级为7问：新增第7问"视角：选择谁的视角？信息藏还是露？视角远近？"
- `step-1-consume.md`新增§5"章意图7问+本章视角决策"——含视角决策必填模板（视角类型/观察机位/内外配比/信息策略/目标效果/切换计划）+章型视角快速指引表
- `step-1-consume.md`本章写作包新增"视角决策"字段
- `step-1-consume.md`门禁新增2项检查（章意图7问已回答+视角决策已填写）
- `SKILL.md`速查表新增`references/视角设计框架.md`
- `SKILL.md`红线新增第8条：视角显式声明红线——每章必须回答章意图第7问并填写视角决策
- `SKILL.md` Step 3.5描述更新：6问→7问
- `SKILL.md` Step 5描述更新：五层指导→六层指导（新增视角层）
- `references/通用技法/镜头切换.md`新增3子技法：对话反打/行动接力/信息转移
