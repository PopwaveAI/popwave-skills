...
> 章节验收 + 存档。就三件事：确认本章正文满意（定稿）→ 生成本章日志 → 更新全书日志。当前版本 v1.8.0，完整版本历史见 [CHANGELOG.md](CHANGELOG.md)。
...
**群像卫生（撤角色即检查，吸收 Mirror 03）**：把人物撤进退出档案时，对照当前"活跃"角色表顺一遍——**同时活跃 ≤5-7 人**（超出读者记不住）；功能重叠的合并一个（两个智囊不如一个智囊+一个执行者）；每个活跃人物都要有"本章在场理由"，没理由的不进画面；退场必须交代（死亡/离开/转背景板），不许人间蒸发。**每 ~20 章顺手清一次活跃表**：谁还起作用、谁该退。
