...
pipeline:
  upstream: [pop-novel-bookstrap, pop-decon]
...
>
> 下游（pop-writer-chapter）只需要读 2 个文件：
...
> 爽点四级定义 + 设计方法论 + 案例 → `references/payoff-design-guide.md`（中/大/特大）+ `pop-writer-chapter/references/payoff-guide.md`（小/中承接）
```
