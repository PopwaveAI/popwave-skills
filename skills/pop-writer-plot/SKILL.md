...
**做什么：** 锁定本卷核心命题、读者感受、起点、终点、篇幅预算、素材需求
**更新/产出：** `剧情设计/卷/卷{N}-卷纲.md`
**❌ 门禁：** 卷目标、起点、终点、篇幅预算任一不清 → 不进入剧情卡筛选
...
**❌ 门禁：** 每幕至少 1 主线 + 2 支线/副线活跃，篇幅预算缺失退回
...
v7.6.0 | 2026-06-22 | 剧情线枪链：不指定章号（未分幕），只记录节点数量+事件brief+卷内位置 → [CHANGELOG.md](CHANGELOG.md)
