---
name: pop-writer-v2-character
description: v2管线·角色设计，增加生态位置/生态关系/生态冲突点字段
pipeline:
  upstream: [pop-writer-v2-world]
  downstream: [pop-writer-v2-plot]
...
upstream `pop-writer-v2-world` → **本skill** → downstream `pop-writer-v2-plot`
