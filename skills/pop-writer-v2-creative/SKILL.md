---
name: pop-writer-v2-creative
description: v2管线·立项+生态调研，生态图谱替代域DNA，文风DNA立项锁定，金手指行动引擎
pipeline:
  upstream: [pop-decon]
  downstream: [pop-writer-v2-world, pop-writer-v2-character, pop-writer-v2-plot]
...
upstream `pop-decon` → **本skill** → downstream `pop-writer-v2-world` / `pop-writer-v2-character` / `pop-writer-v2-plot`
