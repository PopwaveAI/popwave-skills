---
name: pop-writer-v2-plot
description: v2管线·剧情架构，危机交叉设计+事件密度基准+情绪闭环检查
pipeline:
  upstream: [pop-writer-v2-character]
  downstream: [pop-writer-v2-chapter]
...
upstream `pop-writer-v2-character` → **本skill** → downstream `pop-writer-v2-chapter`
