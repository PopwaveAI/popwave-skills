---
name: pop-writer-v2-prose
description: v2管线·正文渲染，文风DNA硬阻塞+场景流渲染+情感内省允许
pipeline:
  upstream: [pop-writer-v2-chapter]
  downstream: [pop-writer-v2-qa]
...
upstream `pop-writer-v2-chapter` → **本skill** → downstream `pop-writer-v2-qa`
