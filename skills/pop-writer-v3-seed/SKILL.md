...
v3.5核心变化：**取消种子文档**。幕纲成为唯一运行时活文档。seed产出的六要素不再是种子文档的字段，而是写作参考/设定/下的独立设定文件。调研工作委托pop-research。活记忆改为自然语言段落格式。seed完成后进入plot环节，plot读取写作参考/设定/下的全局设定设计幕纲。
...
> seed完成后进入plot环节。plot读取写作参考/设定/下的全局设定，设计幕纲。
