...
> 9种排版范式，每页有独立的视觉风格。主题色仅控制色板，不改变排版。
...
- 每个 `page.type` 映射唯一的 CSS class 与唯一的 JS 渲染函数
...
| synopsis | **Magazine Editorial** 杂志页 | `page-magazine` | 左180px深色边栏（竖排眉标与巨大页码）、右内容区、时间线圆点 |
...
| verdict | **Back Cover** 封底 | `page-backcover` | 深色渐变底、居中评分大数字、推荐与不推荐双栏、底部引言 |
...
| 主题 | 适用 | 主色 |
|:--|:--|:--|
| literary-red | 文学与言情（默认） | 金棕 gold |
| ink-blue | 仙侠与玄幻 | 海蓝 blue |
| warm-paper | 都市与现实 | 赤红 red |
| dark-modern | 悬疑与科幻 | 霓虹橙 |
| diary-orange | 青春与校园 | 深橙 orange |
