...
# -*- coding: utf-8 -*-
"""
R41-B seed测试：用王道4（我拿病历号脉）验证v13.9.0对不同创意的稳定性

跳过段1发散，直接用王道4作为选定创意，走段2（打磨→创意.md）+段3（首章）
"""
...
# ============ 王道4选定创意（从R41 phase1-发散.md提取）============
WANGDAO4 = """#### [王道] 王道4：我拿病历号脉
...
def main():
    ...
    print("=" * 60)
    print(f"R41-B seed测试：王道4（我拿病历号脉）验证v13.9.0稳定性")
    print("=" * 60)

    meta = {"creative": "王道4-我拿病历号脉", "phases": []}
    ...
    meta_path = os.path.join(OUTPUT_DIR, "r41b-meta.json")
