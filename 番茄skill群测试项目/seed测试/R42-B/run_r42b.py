...
# -*- coding: utf-8 -*-
"""
R42-B seed测试：末世流创意验证v13.10.1世界SOP规则差异三层通用性
用末世流（非病灵）验证规则差异三层是否通用
"""
...
# R42-B: 末世流创意（火泉）
CREATIVE = """#### [猎奇] 猎奇1：最后的火泉守夜人
- 一句话描述：永夜降临三年后，主角是一个守护着最后一口火泉的孤独守夜人，每天靠分配火泉配额活命，直到有一天他发现火泉底下藏着能让太阳重新升起的东西。
- 画面：零下四十度的夜里，主角蹲在火泉边用铁壶热雪水。火泉只有拳头大，但光是暖的。远处传来脚步声——又是来抢火泉的。他头也不抬："配额明天才发，想插队的去冰面上睡一觉。"
- 为什么有意思：把"资源管理"和"末世求生"结合，火泉既是生命线也是权力源泉。守夜人的身份让他既是保护者也是被觊觎的目标。
- 市场定位：末世生存流的变种——不是丧尸末世而是永夜末世，核心冲突从"打怪"变成"守资源"。
**立项评估**：
- 世界：永夜世界，火泉是唯一光热源，没有火泉的地方就是死地
- 舞台：火泉正在衰竭，各方势力争夺残存火泉，更大的危机是永夜本身在扩张
- 主角：守夜人能感知火泉的"心跳"，力量路径从感知→引导→点燃→复苏
...
def main():
    ...
    print("=" * 60)
    print(f"R42-B: 末世流（火泉守夜人）验证v13.10.1世界SOP通用性")
    print("=" * 60)
